...
const DashboardShortcut = () => {
  return (
    <>
    <div className="main flex flex-col gap-2 bg-[#20202a] rounded-md p-3 px-4 w-[95%]  ml-3 md:ml-0">
      <FlexWrapper>
        ...
        <div className=" rounded-full bg-[#484a4d] p-1 w-10 h-10 flex justify-center items-center">
